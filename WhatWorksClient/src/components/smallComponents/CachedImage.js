...
class CachedImageComp extends Component {
  mounted = true;
  state = {
    imgURI: '',
  };
...
export default function CachedImg(props) {
  let appContext = React.useContext(ReviewContext);

  return <CachedImageComp appContext={appContext} {...props}></CachedImageComp>
};